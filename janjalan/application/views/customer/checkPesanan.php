...
<html>
	...
	<body class="w3-light-grey">
	 ...
	 <div class="w3-bar w3-theme-d3">
		 <h2 style="margin-left:2%;">Check Pesanan</h2>
	 </div>
     ...
     <div class = "w3-leftbar w3-border-green w3-hover-shadow w3-display-container w3-card w3-panel w3-margin w3-padding-large">
       ...
       <div class = "w3-rest w3-padding">
         ...
         <div class = "w3-border-top w3-padding ">
           <ul>
             <li>Nama Pemesan : Susan</li>
             <li>Check In : 23 Oktober 2018</li>
             <li>Check out : 25 Oktober 2018</li>
             <li>Tipe Kamar : Twin-bed</li>
           </ul>
         </div>
         <a href="<?php echo base_url().'tocustomerhotelreview' ?>" class="w3-btn w3-black" type="submit" style="margin-left:38%; margin-top : 3%;"> REVIEW HOTEL</a>
       </div>
     </div>
   </div>
    </header>
